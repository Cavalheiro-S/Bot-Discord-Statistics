...
function getUrlImageIcon(idIcon) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, "http://ddragon.leagueoflegends.com/cdn/12.4.1/img/profileicon/".concat(idIcon, ".png")];
        });
    });
}
...
function getInfoByNamePlayer(name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, index_1.default.get("https://br1.api.riotgames.com/lol/summoner/v4/summoners/by-name/".concat(name, "?api_key=").concat(process.env.RIOT_API_KEY))
